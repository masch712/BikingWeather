...
aws lambda update-function-code --function-name PutWeatherForecastsToDatabase --s3-bucket biking-weather-builds --s3-key build.zip
aws lambda update-function-configuration --function-name PutWeatherForecastsToDatabase --handler 'cron.putForecasts'
