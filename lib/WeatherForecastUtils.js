...
/**
 * Create a moment in the given timezone that represents millis from that timezone's epoch.
 * @param {number} millis 
 * @param {string} tz 
 */
exports.epochMillisToTz = function epochMillisToTz(millis, tz) {
    return moment.tz(moment(this.msSinceEpoch).format("YYYY-MM-DDTHH:mm:ss"), tz);
}