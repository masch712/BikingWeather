...
exports.getTomorrowsCommuteForecasts = function getTomorrowsCommuteForecasts(forecasts, startHour, endHour) {
    ...
    const tomorrowCommuteBeginning = moment(tomorrowBeginning).add(startHour, 'hours').valueOf();
    const tomorrowCommuteEnd = moment(tomorrowBeginning).add(endHour, 'hours').valueOf();
